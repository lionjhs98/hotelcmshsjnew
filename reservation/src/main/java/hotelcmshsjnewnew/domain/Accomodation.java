...
public class Accomodation {
    ...
    public void onPostPersist() {
        ...
        hotelcmshsjnewnew.external.Housekeeping housekeeping = new hotelcmshsjnewnew.external.Housekeeping();
        // mappings goes here
        ReservationApplication.applicationContext
            .getBean(hotelcmshsjnewnew.external.HousekeepingService.class)
