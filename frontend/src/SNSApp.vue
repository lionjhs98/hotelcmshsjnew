            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    ...
                    <v-list-item
                        class="px-2"
                        key="housekeepings"
                        to="/assigningstatuses/housekeepings"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="housekeepings"
                        to="/cleaningstatuses/housekeepings"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
    ...
    data: () => ({
        ...
        aggregate: [
            { 
                ...
                description: '', 
                key: 'accomodations', 
                route: '/reservations/accomodations',
                ImageUrl: '',
            },
            { 
                title: 'Housekeeping', 
                description: '', 
                key: 'housekeepings', 
                route: '/assigningstatuses/housekeepings',
                ImageUrl: '',
            },
            { 
                title: 'Room', 
            ...
            { 
                ...
                description: '', 
                key: 'housekeepings', 
                route: '/cleaningstatuses/housekeepings',
                ImageUrl: '',
            },
